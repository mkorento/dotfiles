...
call s:highlight( 'Normal'      , 'none'  , 'blue'       , 'yellow'     )
call s:highlight( 'PreProc'     , 'none'  , 'red'     , 'none'      )
call s:highlight( 'Keyword'     , 'none'  , 'darkgreen'   , 'none'      )
call s:highlight( 'Number'      , 'none'  , 'blue'        , 'none'      )
call s:highlight( 'String'      , 'none'  , 'blue' , 'none'      )
call s:highlight( 'Function'    , 'none'  , 'darkgreen'   , 'none'      )
call s:highlight( 'Special'     , 'none'  , 'magenta'     , 'none'      )
call s:highlight( 'Statement'   , 'none'  , 'red'     , 'none'      )
call s:highlight( 'Type'        , 'none'  , 'darkmagenta'        , 'none'      )
...
call s:highlight( 'LineNr'      , 'none'   , 'magenta'    , 'none'      )
...
call s:highlight( 'SignColumn'  , 'none'   , 'darkmagenta', 'yellow'     )
call s:highlight( 'SpecialKey'  , 'none'   , 'blue'       , 'none'      )
call s:highlight( 'StatusLine'  , 'none'   , 'darkred'    , 'yellow'     )
