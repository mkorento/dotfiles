...
call s:highlight( 'Search'      , 'none'   , 'black'    , 'darkgray'   )
...
call s:highlight( 'IncSearch'   , 'none'   , 'black'    , 'gray'       )
...
call s:highlight( 'PmenuSel'    , 'none'   , 'black'      , 'violet'      )
...
highlight Merkkijono cterm=NONE ctermfg=8 ctermbg=NONE
