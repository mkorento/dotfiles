(defconst *black* "#002B36")
(defconst *red* "#AF0000")
(defconst *green* "#00AF00")
(defconst *yellow* "#CB4B16")
(defconst *blue* "#586E75")
(defconst *magenta* "#6C71C4")
(defconst *cyan* "#2AA198")
(defconst *white* "#839496")
(defconst *brightblack* "#586E75")
(defconst *brightred* "#DC322F")
(defconst *brightgreen* "#00C88A")
(defconst *brightyellow* "#B58900")
(defconst *brightblue* "#268BD2")
(defconst *brightmagenta* "#D33682")
(defconst *brightcyan* "#2AA198")
(defconst *brightwhite* "#FDF6E3")

(defconst *foreground* *white*)
(defconst *background* *brightwhite*)
...
(custom-theme-set-faces
 ...
 `(Info-quoted ((t (:inherit fixed-pitch-serif :foreground ,*white*))))
 `(apropos-function-button ((t (:inherit (font-lock-function-name-face button) :foreground ,*yellow*))))
 `(apropos-keybinding ((t (:inherit underline :foreground ,*white*))))
 `(apropos-misc-button ((t (:inherit (font-lock-constant-face button) :foreground ,*yellow*))))
 `(apropos-property ((t (:inherit font-lock-builtin-face :foreground ,*yellow*))))
 `(apropos-symbol ((t (:inherit bold :foreground ,*brightblue*))))
 `(apropos-user-option-button ((t (:inherit (font-lock-variable-name-face button) :foreground ,*yellow*))))
 `(apropos-variable-button ((t (:inherit (font-lock-variable-name-face button) :foreground ,*yellow*))))
