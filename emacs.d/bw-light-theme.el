...
(custom-theme-set-faces
 'bw-light
 `(avy-lead-face ((t (:foreground ,*brightred* :background ,*brightwhite*))))
 `(avy-lead-face-0 ((t (:foreground ,*brightred* :background ,*brightwhite*))))
 `(avy-lead-face-1 ((t (:foreground ,*brightred* :background ,*brightwhite*))))
 `(avy-lead-face-2 ((t (:foreground ,*brightred* :background ,*brightwhite*))))
 `(avy-background-face ((t (:foreground ,*brightblack*))))
 `(region ((t (:background ,*background* :foreground ,*blue*))))
 `(secondary-selection ((t (:background ,*brightyellow* :foreground ,*brightwhite*))))
 ...
 `(lazy-highlight ((t (:background ,*background* :foreground ,*brightwhite*))))
 `(isearch ((t (:background ,*brightblack* :foreground ,*brightwhite*))))
 `(mode-line ((t (:background ,*background* :foreground ,*brightwhite*))))
 `(mode-line-inactive ((t (:background ,*brightwhite* :foreground ,*brightwhite*))))
 `(query-replace ((t (:inherit (isearch)))))
 `(font-lock-comment-face ((t (:foreground ,*background*))))
 `(font-lock-string-face ((t (:foreground ,*background*))))
 `(fringe ((t (:background ,*background* :foreground ,*blue*))))
 `(window-divider ((t (:background ,*background* :foreground ,*blue*))))
 `(vertical-border ((t (:background ,*background* :foreground ,*brightblack*))))
 `(border ((t (:background ,*background* :foreground ,*brightblack*))))
