...
(defconst *cyan* "cyan")
(defconst *white* "brightblack")
(defconst *brightblack* "white")
...
(custom-theme-set-faces
 'bw-dark
 `(region ((t (:background ,*white* :foreground ,*blue*))))
 ...
 `(window-divider ((t (:background ,*white* :foreground ,*blue*))))
 `(vertical-border ((t (:background ,*white* :foreground ,*brightblack*))))
 `(border ((t (:background ,*white* :foreground ,*brightblack*))))
